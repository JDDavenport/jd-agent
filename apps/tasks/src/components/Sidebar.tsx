                  ...
                  return (
                    <div key={parent.id}>
                      ...
                      <div className="group/project relative flex items-center">
                        {/* Chevron toggle for children - separate from navigation */}
                        {hasChildren && (
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                            ...
                            className="absolute left-1 z-10 p-0.5 hover:bg-gray-200 rounded"
                          >
                            {isExpanded ? (
