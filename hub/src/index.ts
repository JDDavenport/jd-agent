...
app.use('*', cors({
  origin: (origin) => {
    ...
    // Allow Study Aide domains (including API subdomain)
    if (origin === 'https://studyaide.app' || origin === 'https://www.studyaide.app' || origin === 'https://api.studyaide.app') return origin;
